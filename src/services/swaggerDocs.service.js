...
import { validateUserOnUpdateSchema, SignUpSchema } from '../models/user/user.models';

import { insertFlowerSchema, validateOnUpdateFlowerSchema } from '../models/flower/flower.models';
...
export const customSwaggerSpec = {
    swaggerDefinition: {
        openapi: '3.0.1',
        info: {
            title: 'Flowers API',
