...
/*#__PURE__*/
function () {
  function userOrdersDocs() {
    (0, _classCallCheck2.default)(this, userOrdersDocs);
  }

  (0, _createClass2.default)(userOrdersDocs, [{
  ...
  return userOrdersDocs;
}();

exports.default = userOrdersDocs;